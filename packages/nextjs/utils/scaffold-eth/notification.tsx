...
const Notification = ({
  ...
  return toast.custom(
    (t: Toast) => (
      <div
        className={`shadow-center shadow-accent bg-base-200 relative flex max-w-sm transform-gpu flex-row items-start justify-between space-x-2 rounded-xl p-4 ease-in-out ${
