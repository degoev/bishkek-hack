  ...
  return (
    <div className="flex w-full flex-col gap-1.5">
      <div className="ml-2 flex items-center">
        {paramType.name && <span className="mr-2 text-xs leading-none font-medium">{paramType.name}</span>}
        <span className="block text-xs leading-none font-extralight">{paramType.type}</span>
      </div>
      {renderInput()}
    </div>
  );
