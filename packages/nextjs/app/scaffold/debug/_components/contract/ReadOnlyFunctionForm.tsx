  ...
  return (
    <div className="flex flex-col gap-3 py-5 first:pt-0 last:pb-1">
      ...
      <div className="flex flex-col flex-wrap justify-between gap-2 md:flex-row">
        <div className="w-full grow md:max-w-[80%]">
          {result !== null && result !== undefined && (
            <div className="bg-secondary overflow-auto rounded-3xl px-4 py-1.5 text-sm break-words">
              <p className="m-0 mb-1 font-bold">Result:</p>
              <pre className="break-words whitespace-pre-wrap">{displayTxResult(result, "sm")}</pre>
            </div>
          )}
        </div>
        <button
