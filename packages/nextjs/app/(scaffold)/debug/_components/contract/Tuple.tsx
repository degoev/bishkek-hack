...
export const Tuple = ({ abiTupleParameter, setParentForm, parentStateObjectKey }: TupleProps) => {
  ...
  return (
    <div>
      <div tabIndex={0} className="collapse-arrow bg-base-200 border-secondary collapse border-2 py-1.5 pl-4">
        <input type="checkbox" className="peer min-h-fit!" />
        <div className="collapse-title text-primary-content/50 min-h-fit! p-0 peer-checked:mb-2 after:top-3.5!">
